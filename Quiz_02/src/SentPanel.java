...
public class SentPanel extends javax.swing.JPanel {
    ...
    public SentPanel(String username) {
        init(username);
    }
    ...
    private void init(String username) {
        ...
        inboxLabel.setText("Outbox");
        inboxLabel.setBounds(320, 50, 100, 30);
        add(inboxLabel);
        ...
        try {
            ...
            getmessageswithreciever_thisuser = conn
                    .prepareStatement("SELECT * FROM messages WHERE sender_username = ?");
            ...
            while (messageswithreciever_thisuser.next()) {
                ...
                dataFillObj.reciver = messageswithreciever_thisuser.getString("recipient_username");
            ...
            for (int i = 0; i < size; i++) {
                data[i][0] = dataFillList.get(i).reciver;
        ...
        refreshButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SentPanel sentPanel = new SentPanel(username);
                sentPanel.setBounds(0, 0, 730, 700);
                javax.swing.JPanel rightPanel = (javax.swing.JPanel) getParent();
                rightPanel.add(sentPanel, "SentMessages");
                ((java.awt.CardLayout) rightPanel.getLayout()).show(rightPanel, "SentMessages");
            }
        });
        add(refreshButton);
